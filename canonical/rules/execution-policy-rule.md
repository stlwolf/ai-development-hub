...
- When executing a plan, place gates, checkpoints, and reviews as separate items between implementation steps. Execute each before proceeding to the next step.
