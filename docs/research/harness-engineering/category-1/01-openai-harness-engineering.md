...
[From model to agent: Equipping the Responses API with a computer environment EngineeringMar 11, 2026](https://openai.com/index/equip-responses-api-computer-environment/)

[Beyond rate limits: scaling access to Codex and SoraEngineeringFeb 13, 2026](https://openai.com/index/beyond-rate-limits/)

[Unlocking the Codex harness: how we built the App ServerEngineeringFeb 4, 2026](https://openai.com/index/unlocking-the-codex-harness/)
