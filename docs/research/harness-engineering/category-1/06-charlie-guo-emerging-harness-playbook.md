...
note: "Top includes Substack UI chrome from fetch; body truncated before comments/footer."
---
...
[Charlie Guo](https://substack.com/@charlieguo)
...
To me, it’s clear we’re past the point of demos and side projects; these are production systems at real scale. And while the specifics differ - Steinberger is a solo practitioner, the OpenAI team is a small squad, Stripe is a 10,000-person company - the patterns they’ve converged on are remarkably similar. [1](https://www.ignorance.ai/p/the-emerging-harness-engineering#footnote-1-188778904)
...
[Charlie Guo](https://substack.com/profile/3625174-charlie-guo)

·

Jan 16

[Read full story](https://www.ignorance.ai/p/the-ai-managers-schedule)
...
For the unfamiliar: AGENTS.md is an emerging open convention - essentially a README for AI agents [2](https://www.ignorance.ai/p/the-emerging-harness-engineering#footnote-2-188778904). It’s a Markdown file at the root of your repository that coding agents automatically read at the start of every session. It tells the agent what it needs to know about your project: build steps, testing commands, coding conventions, architectural constraints, and common pitfalls.
...
[Read full story](https://www.ignorance.ai/p/idle-thoughts-on-programming-and-ai)
...
Steinberger observed that engineers who love solving algorithmic puzzles struggle to go agent-native, while those who love shipping products adapt quickly [5](https://www.ignorance.ai/p/the-emerging-harness-engineering#footnote-5-188778904). This tracks with something I’ve seen firsthand - I’ve had to learn to let go of the craft of software engineering as I drift from writing the code with my own hands.
