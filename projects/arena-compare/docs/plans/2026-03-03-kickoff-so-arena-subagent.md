...
related:
  - type: derived_from
    ref: attelu/attelu/docs/ai-automation-roadmap/02-so-arena-subagent.md
    reason: "SO/Arena サブエージェント化の元課題ドキュメント"
  - type: derived_from
    ref: attelu/attelu/docs/ai-automation-roadmap/03-persistent-exploration.md
...
元ドキュメント: `attelu/attelu/docs/ai-automation-roadmap/02-so-arena-subagent.md`
...
元ドキュメント: `attelu/attelu/docs/ai-automation-roadmap/03-persistent-exploration.md`
...
- `attelu/attelu/docs/ai-automation-roadmap/02-so-arena-subagent.md` — 元課題ドキュメント（課題2）
- `attelu/attelu/docs/ai-automation-roadmap/03-persistent-exploration.md` — 元課題ドキュメント（課題3）
