...
関連: `tests/test_oe_lane_explain.sh`（54 件）/ `tests/fixtures/so-lane-failures/SOURCE.md`（fixture の出所と2つの陰性対照）/ `docs/plans/2026-09-07-plan-303-so-lane-failure-classification.md`（I-1）。
