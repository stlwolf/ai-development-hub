...
related:
  - type: derived_from
    ref: ../episodes/2026-02-10-claude-safe-orchestration-verification.md
    reason: "前回のclaude-safe検証から継続した検証計画"
tags: [codex, cli, verification, plan, comparison]
keywords: [codex-cli, exec, sandbox, AGENTS.md, session, JSONL]
use_when:
  - "Codex CLI の検証を実施するとき"
  - "Codex CLI の基本コマンド体系を確認したいとき"
---
